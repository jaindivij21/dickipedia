...
export const factQualifiers = sqliteTable("fact_qualifiers", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const factSources = sqliteTable("fact_sources", {
  factId: integer("fact_id").notNull(),
...
export const subjectRestrictions = sqliteTable("subject_restrictions", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  subjectId: integer("subject_id").notNull(),
...
export const recentChanges = sqliteTable("recent_changes", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  timestamp: integer("timestamp").notNull(),
  actorId: integer("actor_id").notNull(),
  subjectId: integer("subject_id"),
...
export const pageDependencies = sqliteTable("page_dependencies", {
  subjectId: integer("subject_id").notNull(),
...
export const talkThreads = sqliteTable("talk_threads", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  subjectId: integer("subject_id").notNull(),
