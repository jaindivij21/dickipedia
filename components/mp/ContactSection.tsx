...
export function ContactSection({ mp }: { mp: Mp }) {
  ...
  return (
    <DataSection
      ...
      src='sansad'
      updatedAt={MANIFEST.sources.sansad?.as_of}
    >
      {!hasContact && !committees.length ? (
        <EmptyState message='No public contact details or committee roles published by the Lok Sabha Secretariat.' />
      ) : (
